...
import 'package:estacao_pilhas/pages/credits_received/controllers/credits_received_controller.dart';
...
class _CreditsReceivedState extends State<CreditsReceived> {
  ...
  void initialRequest() async {
    var response =
        await CreditsReceivedController().makePayment(widget.paymentId);
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  "${payment.quantidadePilhaAA! + payment.quantidadePilhaAAA! + payment.quantidadePilhaC! + payment.quantidadePilhaD! + payment.quantidadePilhaV9!} Pilhas",
